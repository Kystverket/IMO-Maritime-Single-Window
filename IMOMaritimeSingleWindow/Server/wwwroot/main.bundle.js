...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__authenticate_xhr_backend__ = __webpack_require__("./src/authenticate-xhr.backend.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_services_auth_request_service__ = __webpack_require__("./src/app/shared/services/auth.request.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_services_constants_service__ = __webpack_require__("./src/app/shared/services/constants.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__main_content_content_container_content_container_module__ = __webpack_require__("./src/app/main-content/content-container/content-container.module.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__main_content_footer_footer_component__ = __webpack_require__("./src/app/main-content/footer/footer.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__main_content_header_header_component__ = __webpack_require__("./src/app/main-content/header/header.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__auth0_angular_jwt__ = __webpack_require__("./node_modules/@auth0/angular-jwt/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ng_bootstrap_ng_bootstrap__ = __webpack_require__("./node_modules/@ng-bootstrap/ng-bootstrap/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__guards_error_guard__ = __webpack_require__("./src/app/guards/error.guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__error_error_module__ = __webpack_require__("./src/app/error/error.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__guards_root_guard__ = __webpack_require__("./src/app/guards/root.guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__shared_constants_blacklisted_routes__ = __webpack_require__("./src/app/shared/constants/blacklisted-routes.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_20__angular_core__["J" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__main_content_content_container_content_container_module__["a" /* ContentContainerModule */],
                __WEBPACK_IMPORTED_MODULE_3__auth_auth_module__["AuthModule"],
                __WEBPACK_IMPORTED_MODULE_22__error_error_module__["a" /* ErrorModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_16__angular_http__["d" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_17__auth0_angular_jwt__["b" /* JwtModule */].forRoot({
                    config: {
                        tokenGetter: tokenGetter,
                        whitelistedDomains: ['localhost:4200'],
                        blacklistedRoutes: __WEBPACK_IMPORTED_MODULE_24__shared_constants_blacklisted_routes__["a" /* BLACKLISTED_ROUTES */]
                    }
                }),
                __WEBPACK_IMPORTED_MODULE_19__ng_bootstrap_ng_bootstrap__["c" /* NgbModule */].forRoot(),
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_1__app_component__["a" /* AppComponent */],
                __WEBPACK_IMPORTED_MODULE_12__main_content_footer_footer_component__["a" /* FooterComponent */],
                __WEBPACK_IMPORTED_MODULE_14__main_content_header_header_component__["a" /* HeaderComponent */],
                __WEBPACK_IMPORTED_MODULE_2__app_routing_module__["b" /* routedComponents */],
            ],
            providers: [
                { provide: __WEBPACK_IMPORTED_MODULE_16__angular_http__["g" /* XHRBackend */], useClass: __WEBPACK_IMPORTED_MODULE_4__authenticate_xhr_backend__["a" /* AuthenticateXHRBackend */] },
                __WEBPACK_IMPORTED_MODULE_0__shared_services_account_service__["a" /* AccountService */],
                __WEBPACK_IMPORTED_MODULE_5__shared_services_auth_request_service__["a" /* AuthRequest */],
                __WEBPACK_IMPORTED_MODULE_6__shared_services_auth_service__["a" /* AuthService */],
                __WEBPACK_IMPORTED_MODULE_8__shared_utils_config_service__["a" /* ConfigService */],
                __WEBPACK_IMPORTED_MODULE_9__shared_services_constants_service__["a" /* ConstantsService */],
                __WEBPACK_IMPORTED_MODULE_11__shared_services_content_service__["a" /* ContentService */],
                __WEBPACK_IMPORTED_MODULE_21__guards_error_guard__["a" /* ErrorGuard */],
                __WEBPACK_IMPORTED_MODULE_17__auth0_angular_jwt__["a" /* JwtHelperService */],
                __WEBPACK_IMPORTED_MODULE_18__shared_services_login_service__["a" /* LoginService */],
                __WEBPACK_IMPORTED_MODULE_23__guards_root_guard__["a" /* RootGuard */]
            ],
...
var RegisterUserComponent = /** @class */ (function () {
    ...
    RegisterUserComponent.prototype.registerUser = function (template) {
        var _this = this;
        this.accountService.registerUser(this.user)
            ...
            if (result) {
                ...
                _this.emailConfirmationLink = result.text();
                _this.openCustomModal(template, true); // SUCCESS
                // this.openConfirmationModal(ConfirmationModalComponent.TYPE_SUCCESS, RESULT_SUCCESS);
            }
        }, function (error) {
            console.log(error);
            _this.openCustomModal(template, false); // FAILURE
    ...
    ClearanceComponent.prototype.saveClearance = function () {
        ...
        if (this.clearanceModel.cleared) {
            this.portCallService.getClearanceListForPortCall(this.clearanceModel.portCallId).subscribe(function (result) {
                ...
                if (allCleared) {
                    _this.portCallService.updatePortCallStatusCleared(_this.clearanceModel.portCallId).subscribe(function (res) { return console.log('Status set to cleared.'); }, function (err) { return console.log(err); });
                }
            });
        }
        else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__components_feedback_feedback_component__ = __webpack_require__("./src/app/shared/components/feedback/feedback.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    SharedModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NgModule */])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_38__components_feedback_feedback_component__["a" /* FeedbackComponent */]
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_10__components_confirmation_modal_confirmation_modal_component__["a" /* ConfirmationModalComponent */],
                __WEBPACK_IMPORTED_MODULE_12__components_confirmation_view_confirmation_view_component__["a" /* ConfirmationViewComponent */],
